...
<div class="main-content">
    ...
    <img class="linhamenor align-self-center d-none d-xl-block mx-5" src="{{ asset('images/linhamenordireita.png') }}" alt="">
    ...
    <img class="linhamenor align-self-center d-none d-xl-block mx-5" src="{{ asset('images/linhamenor.png') }}" alt="">
</div>
