                        ...
                        <div class="row">
                            @forelse($casos as $caso)
                                <div class="col-md-6">
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <a href="{{ route('caso', ['caso_id' => $caso->caso_id, 'usuario_id' => $usuario->usuario_id]) }}">
                            ...
                            @empty
                                <div class="col-md-12">
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <h5 id="" class="titulo col-xl-12 text-center" style="text-transform: uppercase;">nenhum caso registrado</h5>
                                        </div>
                                    </div>
                                </div>
                            @endforelse
